...
<html lang="en">
	<head>
		...
		<link href="<?=base_url() ?>css/<?=$this -> config_theme ?>/scrollbars.css" rel="stylesheet">
		<link href="<?=base_url() ?>css/<?=$this -> config_theme ?>/speed-use.css" rel="stylesheet">
		<link href="<?=base_url() ?>css/<?=$this -> config_theme ?>/lightning.css" rel="stylesheet">
	...
	<body>
		<div class="bodycontain">
			<div class="navbar navbar-inverse ">
				...
				<div class="navbar-access">
					<div class="container">
						<div class="logo" ><img src="<?=base_url() ?>css/access360/images/logoBig.png"/>
						</div>
		...
		<script src="<?=base_url() ?>js/scrollbars.js"></script>
